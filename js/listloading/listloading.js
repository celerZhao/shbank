...
Listloading.prototype = {
    ...
    init: function (options) {
        this.options = {};
        // 上拉刷新文字
        this.options.upLoadmoretxt     = '<i class="icon-angledoubleup"></i>上拉加载更多';
        // 下拉刷新文字
        this.options.pullDrefreshtxt   = '<i class="icon-angledoubledown"></i>下拉加载更多';
        // 正在加载中文字
    ...
    scrollEvent: function () {
        ...
        iscroll.on('scrollMove', function(){
            ...
            if ( y > gapY && !pullDownEleCls ) {
                // 设置class和提示
                toggleClassText(pullDownEle, 'flip', 'pullDownLabel', '<i class="icon-angledoubleup"></i>' + Realtimetxt);
            }
            // 下拉刷新
                ...
                // 设置class和提示
                toggleClassText(pullUpEle, 'flip', 'pullUpLabel', '<i class="icon-angledoubledown"></i>' + Realtimetxt);
            } 
            else if (pullUpEle && y > (maxScrollY + gapY) && pullUpEleCls) {
                // 设置class和提示
                toggleClassText(pullUpEle, '', 'pullUpLabel', upLoadmoretxt);
